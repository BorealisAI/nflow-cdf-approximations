...
class MLP(nn.Module):
    ...
    def __init__(self, nin, nout, nh, activation=nn.Tanh):
        super().__init__()
...
class ARMLP(nn.Module):
    """ a 1-layer auto-regressive MLP, wrapper around MADE net """

    def __init__(self, nin, nout, nh, act):
        super().__init__()
        self.net = MADE(nin, [nh], nout, act, num_masks=1, natural_ordering=True)
